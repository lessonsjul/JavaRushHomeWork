...
public class Solution {
    public static void main(java.lang.String[] args) {
        ...
        try {
            ...
            System.out.println(object.string2.equals(loadedObject.string2));
    ...
    public static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            java.lang.String isLine = string1 != null ? "yes" : "no";
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            if ((line =reader.readLine()).equals("yes")){
                line = reader.readLine();
                int index = Integer.parseInt(line.split("#")[1]);
                countStrings = --index;
                this.string1 = new Solution.String();
                if(reader.readLine().equals("yes")){
                    line = reader.readLine();
                    index = Integer.parseInt(line.split("#")[1]);
                    countStrings = --index;
                    this.string2 = new Solution.String();
                }
            }
